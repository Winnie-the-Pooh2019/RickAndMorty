...
class EpisodeActivity : AppCompatActivity() {
    ...
    private val character: Character by lazy { Gson().fromJson(
        intent.getStringExtra("CharacterData"), Character::class.java) }

    private val model: EpisodeViewModel by Factories.viewModelFactory(this) { EpisodeViewModel(RetrofitBuilder.service, character.episode) }
